...
<!-- Flowbite Modal -->
<div id="defaultModal" tabindex="-1" class="hidden fixed top-0 left-0 right-0 z-50 justify-center items-center w-full h-full">
    <div class="bg-white p-6 rounded shadow">
        <h2 class="text-xl font-bold">Hello Flowbite 👋</h2>
        <button data-modal-hide="defaultModal" class="mt-4 bg-red-500 text-white px-4 py-2 rounded">
            Close
        </button>
    </div>
</div>
